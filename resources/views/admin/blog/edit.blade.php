                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            @if($blog->image)
                                <div class="mb-2">
                                    <img src="{{ Storage::url($blog->image) }}" alt="{{ $blog->title }}" class="img-fluid rounded" style="max-height: 150px;">
                                    <small class="d-block text-muted mt-1">Ảnh hiện tại. Upload ảnh mới để thay thế.</small>
                                </div>
                            @endif
