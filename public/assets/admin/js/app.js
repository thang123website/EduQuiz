!function () {
    ...
    function n(e) {
        document.getElementById("header-lang-img") && ("en" == e ? document.getElementById("header-lang-img").src = `${PATH_ROOT}/assets/admin/images/flags/us.svg` : "sp" == e ? document.getElementById("header-lang-img").src = `${PATH_ROOT}/assets/admin/images/flags/spain.svg` : "gr" == e ? document.getElementById("header-lang-img").src = `${PATH_ROOT}/assets/admin/images/flags/germany.svg` : "it" == e ? document.getElementById("header-lang-img").src = `${PATH_ROOT}/assets/admin/images/flags/italy.svg` : "ru" == e ? document.getElementById("header-lang-img").src = `${PATH_ROOT}/assets/admin/images/flags/russia.svg` : "ch" == e ? document.getElementById("header-lang-img").src = `${PATH_ROOT}/assets/admin/images/flags/china.svg` : "fr" == e ? document.getElementById("header-lang-img").src = `${PATH_ROOT}/assets/admin/images/flags/french.svg` : "ar" == e && (document.getElementById("header-lang-img").src = `${PATH_ROOT}/assets/admin/images/flags/ae.svg`), localStorage.setItem("language", e), null == (a = localStorage.getItem("language")) && n(t), location.protocol !== "file:" ? ((e = new XMLHttpRequest).open("GET", `${PATH_ROOT}/assets/admin/lang/` + a + ".json"), e.onreadystatechange = function () {
            var a;
        ...
        }, e.send()) : console.warn("Translation skipped: CORS restriction on file:// protocol. Use a local server to enable translations."))
    }
            ...
            0 < e.querySelectorAll(".notification-item").length ? e.querySelector(".view-all") && (e.querySelector(".view-all").style.display = "block") :
                (e.querySelector(".view-all") && (e.querySelector(".view-all").style.display = "none"),
                    ...
                    (e.innerHTML +=
                        ...
                        `<img src="${PATH_ROOT}/assets/admin/images/svg/bell.svg" class="img-fluid" alt="user-pic">\t\t\t\t\t\t\t` +
    ...
    sessionStorage.getItem("defaultAttribute") ? ((f = {})["data-layout"] = sessionStorage.getItem("data-layout"), f["data-sidebar-size"] = sessionStorage.getItem("data-sidebar-size"), f["data-bs-theme"] = sessionStorage.getItem("data-bs-theme"), f["data-layout-width"] = sessionStorage.getItem("data-layout-width"), f["data-sidebar"] = sessionStorage.getItem("data-sidebar"), f["data-sidebar-image"] = sessionStorage.getItem("data-sidebar-image"), f["data-layout-position"] = sessionStorage.getItem("data-layout-position"), f["data-layout-style"] = sessionStorage.getItem("data-layout-style"), f["data-topbar"] = sessionStorage.getItem("data-topbar"), f["data-preloader"] = sessionStorage.getItem("data-preloader"), f["data-body-image"] = sessionStorage.getItem("data-body-image"), e(f)) : (L = document.documentElement.attributes, f = {}, Array.from(L).forEach(function (e) {
        ...
        a["data-choices-groups"] && (t.placeholderValue = "This is a placeholder set in the config"), a["data-choices-search-false"] && (t.searchEnabled = !1), a["data-choices-search-true"] && (t.searchEnabled = !0), a["data-choices-removeItem"] && (t.removeItemButton = !0), a["data-choices-sorting-false"] && (t.shouldSort = !1), a["data-choices-sorting-true"] && (t.shouldSort = !0), a["data-choices-multiple-remove"] && (t.removeItemButton = !0), a["data-choices-limit"] && (t.maxItemCount = a["data-choices-limit"].value.toString()), a["data-choices-limit"] && (t.maxItemCount = a["data-choices-limit"].value.toString()), a["data-choices-editItem-true"] && (t.maxItemCount = !0), a["data-choices-editItem-false"] && (t.maxItemCount = !1), a["data-choices-text-unique-true"] && (t.duplicateItemsAllowed = !1), a["data-choices-text-disabled-true"] && (t.addItems = !1), t.allowHTML = !0, a["data-choices-text-disabled-true"] ? new Choices(e, t).disable() : new Choices(e, t)
